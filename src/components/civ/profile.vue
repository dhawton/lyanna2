<template>
  <div>
    <License :showedit="true" v-if="prepared" v-bind:documents="documents" />
    <b-row>
      <b-col md="12">
    ...
    updateDocuments() {
      this.$apollo.query({
        ...
        docs.forEach((v, i) => {
          ...
          let dt = new Date(docs[i].created_at).toLocaleString("en-US", { timeZone: "America/Chicago", hour12: false });
